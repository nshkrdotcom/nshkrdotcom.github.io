...
cat > "$success_stub_dir/rsvg-convert" <<'SH'
#!/bin/sh
output_path=""
while [ "$#" -gt 0 ]; do
    case "$1" in
...
exit 1
SH
chmod +x "$failure_stub_dir/rsvg-convert"
