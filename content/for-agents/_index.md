...
|---------|-------|------------------|
| [Geometry of Conditional Truth](https://github.com/nshkrdotcom/gct) | Context transport and hidden-coordinate structure across Qwen3-4B and Phi-4-mini | Broad simple-state transport null replicated; narrower Phi residual decodability does not establish causal use or universal geometry |
...
| [Attention Lab](https://github.com/nshkrdotcom/attention_lab) | Matched GPT pretraining and alternative-attention probes | E003/E004 full-depth work exists; confirmatory mechanism status remains `insufficient_evidence` |
